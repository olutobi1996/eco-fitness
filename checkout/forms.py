...
class OrderForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'street_address2': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Street Address 2 (Optional)'}),
            'county': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'County/State'}),
        }

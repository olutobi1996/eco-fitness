...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('fitness_plans', 'Fitness Plans'), ('diet_plans', 'Diet Plans'), ('eco_friendly_activewear', 'Eco-Friendly Activewear'), ('recycled_fitness_gear', 'Recycled Fitness Gear'), ('vegan_supplements', 'Vegan Supplements'), ('biodegradable_accessories', 'Biodegradable Accessories')], max_length=50, unique=True)),

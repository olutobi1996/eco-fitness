...
CSRF_TRUSTED_ORIGINS = [
    ...
    "https://8000-olutobi1996-ecofitness-r9z8d8gtyac.ws-eu119.gitpod.io",
]
...
MIDDLEWARE = [
    ...
    # Ensure whitenoise is above other middlewares
...
# Cloudinary: for blog image model storage ONLY
CLOUDINARY_STORAGE = {
...
DJSTRIPE_WEBHOOK_SECRET = STRIPE_WH_SECRET
